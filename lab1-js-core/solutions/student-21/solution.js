...
function runTests() {
    ...
    console.assert(validateEmail("test@example.com") === true, "Email валидный провален");
    console.assert(validateEmail("invalid-email.com") === false, "Email невалидный провален");
